 ...
 * </br>
 */
public class SparseMatrixUniqueValueImplTest extends TestCase {
    // 1. override constructor
    public SparseMatrixUniqueValueImplTest(String name) {
        super(name);
    }
    ...
    public void testSetValue() {
        ...
        assertTrue(m.getValue(10,25)==10);
        m.setValue(10,26,10);
        assertTrue(m.getValue(10,26)==10);
    ...
    public static Test suite() {
        return new TestSuite(SparseMatrixUniqueValueImplTest.class);
    }
