 ...
 * ------------------------ */
    ...
    public QRDecomposition(Matrix matrix) {
        hint = matrix;
        // Initialize.
        QR = Matrices.getArray(matrix);        //changed
 ...
 * ------------------------ */
    ...
    public Matrix solve(Matrix b) {
        ...
        int nx = b.cols();
        double[][] X = Matrices.getArray(b);        //changed
        ...
        return Matrices.getSubMatrix(MatrixFactory.getMatrix(b.rows(), b.cols(), hint, X),1,1,n,nx);
    }
}
