package org.jmatrices.complex;

import org.jcomplex.dbl.Complex;


/**
 * Matrix represents a <strong>structurally immutable</strong> matrix of complex numbers with <strong>index begining at 1</strong>.
 * <p>
 * The only way to change the elements in a matrix is through {@link #set(int, int, org.jcomplex.dbl.Complex)}
 * </p><p>
