package org.jmatrices.bigdecimal;

import java.math.BigDecimal;

/**
 * Matrix represents a <strong>structurally immutable</strong> matrix of numbers(BigDecimal) with <strong>index begining at 1</strong>.
 * <p>
 * The only way to change the elements in a matrix is through {@link #set(int, int, java.math.BigDecimal)}
 * </p><p>
