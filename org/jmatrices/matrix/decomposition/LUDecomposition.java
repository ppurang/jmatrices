 ...
 * ------------------------ */
    ...
    public Matrix getL() {
        ...
        return MatrixFactory.getMatrix(m, n, L);     //changed
    }
    ...
    public Matrix getU() {
        ...
        return MatrixFactory.getMatrix(m, n, U);
    }
    ...
    public Matrix getPivotMatrix() {
        ...
        return MatrixFactory.getMatrix(dblPivot.length, 1, dblPivot);
    }
    ...
    public Matrix solve(Matrix B) {
        ...
        return MatrixFactory.getMatrix(Xmat.rows(), Xmat.cols(), X);
    }
