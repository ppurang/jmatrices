 ...
 * ------------------------ */
    ...
    public Matrix getH() {
        ...
        return MatrixFactory.getMatrix(m, n, H);  //changed
    }
    ...
    public Matrix getR() {
        ...
        return MatrixFactory.getMatrix(n, n, R); //changed
    }
    ...
    public Matrix getQ() {
        ...
        return MatrixFactory.getMatrix(m, n, Q);
    }
    ...
    public Matrix solve(Matrix B) {
        ...
        return MatrixFactory.getMatrix(B.rows(), B.cols(), X).getSubMatrix(1, 1, n, nx); //changed  taking care of 1,1 (index start) and differences between getMatrix and getSubMatrix
    }
}
