 ...
 * ------------------------ */
    ...
    public Matrix getU() {
        ...
        return MatrixFactory.getMatrix(m, Math.min(m + 1, n), U);
    }
    ...
    public Matrix getV() {
        return MatrixFactory.getMatrix(n, n, V);
    }
    ...
    public Matrix getS() {
        ...
        return MatrixFactory.getMatrix(m, n, S);  //changed n to m
    }
