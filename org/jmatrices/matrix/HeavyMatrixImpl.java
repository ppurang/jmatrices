 ...
 * Time: 16:06:08
 */
public class HeavyMatrixImpl extends LightMatrixImpl implements Matrix {
    ...
    public HeavyMatrixImpl(int rows, int cols, double[][] elems) {
        this(rows, cols);
        populateElements(elems); // we can't use super(rows,cols,elems) as super doesn't initialize colView
    }
