...
public interface Matrix {
    ...
    //todo should we return arrays or matrices?  we don't have to return arrays as get returns the store array perhaps we should move these to transform package!!!
    /**
