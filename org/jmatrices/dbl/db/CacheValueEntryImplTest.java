 ...
 * </br>
 */
public class CacheValueEntryImplTest extends TestCase {
    // 1. override constructor
    public CacheValueEntryImplTest(String name) {
        super(name);
    }

    // 2. implement tests as public methods
    public void testNumberOfRetrivals() {
        CacheValueEntry cacheValueEntry = new CacheValueEntryImpl(2.3D);
    ...
    public static Test suite() {
        return new TestSuite(CacheValueEntryImplTest.class);
    }
