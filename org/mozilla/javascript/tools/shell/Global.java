...
public class Global extends ImporterTopLevel {
    ...
    public Global(Context cx)
    {
       ...
       /*try {
            defineFunctionProperties(MatlabEnv.getFunctionNames(), MatlabEnv.class,
                                     ScriptableObject.DONTENUM);
        } catch (PropertyException e) {
            throw new Error();  // shouldn't occur.
        }
        ...
        try {
            defineProperty("ms",org.jmatrices.dbl.syntax.MatlabSyntax.class,ScriptableObject.DONTENUM);
        } catch (PropertyException e) {
            throw new Error();  // shouldn't occur.
        }  */
    ...
    /**
     * Get and setValue the language version.
     *
     * This method is defined as a JavaScript function.
     */
    ...
    /**
     * Load and execute a setValue of JavaScript source files.
     *
     * This method is defined as a JavaScript function.
     *
     */
